...
echo "Swarm JobID:"
#
swarm -f swarm_gathervcfs.txt -g 8 --time 8:00:00 --gres=lscratch:75 --module GATK/4.1.0.0 --logdir ~/job_outputs/gatk/gathervcfs/$SWARM_NAME --sbatch "--mail-type=ALL,TIME_LIMIT_80 --job-name $SWARM_NAME"
